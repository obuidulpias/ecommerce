            ...
            <div class="row">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="cart-thumb media align-items-center">
                                            <a href="#">
                                                <img class="img-fluid" src="../../../static/assets/images/product/p10.jpg" alt="">
                                            </a>
                                ...
                                <tr>
                                    <td>
                                        <div class="cart-thumb media align-items-center">
                                            <a href="#">
                                                <img class="img-fluid" src="../../../static/assets/images/product/p13.jpg" alt="">
                                            </a>
                                            <div class="media-body ml-3">
                                                <div class="product-title mb-2"><a class="link-title" href="#">Unpaired Running Shoes</a>
                                                </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="cart-thumb media align-items-center">
                                            <a href="#">
                                                <img class="img-fluid" src="../../../static/assets/images/product/p11.jpg" alt="">
                                            </a>
                                            <div class="media-body ml-3">
                                                <div class="product-title mb-2"><a class="link-title" href="#">Unpaired Running Shoes</a>
                                                </div>
                ...
                <div class="col-lg-4 pl-lg-5 mt-8 mt-lg-0">
                    <div class="border rounded p-5 bg-light-4">
                        ...
                        </div> <router-link class="btn btn-primary btn-animated btn-block" to="/checkout">Proceed To Checkout</router-link>
